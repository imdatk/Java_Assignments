...
//		Ask the user to enter count for seniorCitizens and nonSeniorCitizens using message:
...
//		-if the citizen's age is less than 65 then print "Non-Senior Citizen" and increment nonSeniorCitizens variable by 1.
