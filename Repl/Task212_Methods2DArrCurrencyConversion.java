...
//
//-money (String[][]): 
//a 2d array of strings, each row gets two places, one for currency type second 
//for the amount:
//[
//["euro","1.5"],
//["yen","21.5"],
...
//]
//
//the amount value is a string you will have to convert it to double to use it 
//for calculations.
//
...
//
//You need to write code to read how much of given currency Bob has and check
//USD conversion rate for that currency in the second array then multiple them 
//to get how much USD he will end up with total.
//
//for example:
...
//Conversion rates are in second array. So we multiple (11.0 * 0.6) +(5.0 * 100) and 
//return the result    )
//
...
public class Task212_Methods2DArrCurrencyConversion {
	...
	public static  double convertC(String[][] money,String[][] conversionRate){
	    double dollars = 0;
			for(int i=0; i<money.length; i++) {
				double currency = Double.parseDouble(money[i][1])*Double.parseDouble(conversionRate[i][1]);
				dollars+= currency;
